...
const Books = () => {
    ...
    return (_jsxs("div", { className: "container mx-auto", children: [_jsx(BreadCrumComponent, {}), _jsx(BooksTable, { data: data?.data, isLoading: isLoading, isError: isError }), _jsx(PaginationDesign, { page: page, handlePage: handlePage, limit: limit, handlePrevious: handlePrevious })] }));
};
